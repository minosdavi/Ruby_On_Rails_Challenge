...
class OrderLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post order_lines_url, params: { order_line: { Order_id: @order_line.Order_id, Product_id: @order_line.Product_id } }
    end
  ...
  test "should update order_line" do
    patch order_line_url(@order_line), params: { order_line: { Order_id: @order_line.Order_id, Product_id: @order_line.Product_id } }
